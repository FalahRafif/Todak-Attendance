    ...
    'menu' => [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Belum Absen Masuk', 'route_name' => 'attendances.not-checked-in', 'active' => ['attendances.not-checked-in'], 'roles' => [RoleName::Hrd->value]],
                ['label' => 'Belum Absen Keluar', 'route_name' => 'attendances.incomplete', 'active' => ['attendances.incomplete'], 'roles' => [RoleName::Hrd->value]],
                ['label' => 'Terlambat', 'route_name' => 'attendances.late', 'active' => ['attendances.late'], 'roles' => [RoleName::Hrd->value]],
                ['label' => 'Diluar Radius', 'route_name' => 'attendances.outside-radius', 'active' => ['attendances.outside-radius'], 'roles' => [RoleName::Hrd->value]],
            ],
        ],
        [
            'section' => 'Approval',
            'items' => [
                ['label' => 'Pengajuan Karyawan', 'route_name' => 'leave-requests', 'active' => ['leave-requests*'], 'roles' => [RoleName::Hrd->value]],
                ['label' => 'Pengajuan Absensi Karyawan', 'route_name' => 'attendance-corrections', 'active' => ['attendance-corrections*'], 'roles' => [RoleName::Hrd->value]],
            ],
        ],
        [
            'section' => 'Reports',
            'items' => [
                ['label' => 'Laporan Kehadiran Harian', 'route_name' => 'reports.daily-attendance', 'active' => ['reports.daily-attendance*'], 'roles' => [RoleName::Hrd->value]],
                ['label' => 'Laporan Kehadiran Bulanan', 'route_name' => 'reports.monthly-attendance', 'active' => ['reports.monthly-attendance*'], 'roles' => [RoleName::Hrd->value]],
            ],
        ],
        [
            'section' => 'HR Data',
            'items' => [
                ...
                ['label' => 'Manage Cuti Karyawan', 'route_name' => 'leave-balances', 'active' => ['leave-balances*'], 'roles' => [RoleName::Hrd->value]],
            ],
        ],
        [
            'section' => 'Employee Portal',
            'items' => [
                ['label' => 'Absensi Hari Ini', 'route_name' => 'attendance', 'active' => ['attendance'], 'roles' => [RoleName::Employee->value]],
                ['label' => 'Kalender Absensi', 'route_name' => 'attendance.calendar', 'active' => ['attendance.calendar*'], 'roles' => [RoleName::Employee->value]],
                ['label' => 'Riwayat Absensi', 'route_name' => 'attendance.history', 'active' => ['attendance.history*'], 'roles' => [RoleName::Employee->value]],
                ['label' => 'Pengajuan Izin', 'route_name' => 'leave-requests', 'active' => ['leave-requests*'], 'roles' => [RoleName::Employee->value]],
                ['label' => 'Pengajuan Perubahan Absensi', 'route_name' => 'attendance-corrections', 'active' => ['attendance-corrections*'], 'roles' => [RoleName::Employee->value]],
