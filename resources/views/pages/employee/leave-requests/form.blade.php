...
<div class="ka-mobile-shell">
    ...
    <div class="ka-form-panel p-3 p-md-4">
        <form method="POST" action="{{ route('employee.leave-requests.store') }}" class="row g-3" id="leave-form">
            ...
            <div class="col-md-4"><label class="form-label">Tanggal Selesai</label><input type="date" name="end_date" id="end_date" class="form-control" required></div>
            <div class="col-12"><div class="ka-total-days"><strong id="total-days">0 hari</strong><div class="small">Total hari dihitung otomatis dari tanggal mulai dan selesai.</div></div></div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function syncDays() {
            if (!start.value || !end.value) { total.textContent = '0 hari'; return; }
