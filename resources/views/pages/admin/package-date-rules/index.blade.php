...
@php
    $actions = [
        // ['label' => 'Tambah Aturan', 'url' => route('admin.package-date-rules.create'), 'class' => 'btn btn-primary btn-sm'],
    ];
@endphp

@include('pages.admin.partials.page-header', [
    'heading' => 'Aturan Waktu Paket',
    'summary' => 'Kelola aturan batas waktu terkait paket berdasarkan hari (H+X / H-X).',
    'actions' => $actions,
])
...
<div class="card custom-card mb-0">
    <div class="card-header">
        <h5 class="card-title mb-0">Daftar Aturan Waktu Paket</h5>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover text-nowrap align-middle mb-0">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="btn-list justify-content-end">
                                    <a href="{{ route('admin.package-date-rules.edit', $rule) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                                    <form method="POST" action="{{ route('api.admin.package-date-rules.destroy', $rule) }}" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus aturan ini?');">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4">Belum ada data aturan waktu paket.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
