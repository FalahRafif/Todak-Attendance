...
@section('title', $title ?? 'Dashboard — Todak Attendace')
...
<div style="padding: 32px 0;">
    <div style="background: linear-gradient(135deg, #0f4c81, #0b2742); color: #fff; border-radius: 24px; padding: 32px; box-shadow: 0 18px 40px rgba(15, 76, 129, .18);">
        <div style="font-size: 13px; letter-spacing: .12em; text-transform: uppercase; opacity: .72; font-weight: 800;">Todak Attendace</div>
